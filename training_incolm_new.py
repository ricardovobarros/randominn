...
list_drop = ["class", "x", "y", "name", "rgb"] #,"wa","tri","lateral","velo"

# Reclassify dataset with 3, 5 of 8 classes
df_train = correct_labels_incolmation(df=df_train, n_classes=4)
...
for i in range(0, n_runs):
    ...
    rfc = RandomForestClassifier(n_estimators=100,  # number of trees
                                 ...
                                 bootstrap=False,  # random selection sample of dataset per tree
    ...
    print()
if n_runs != 1:
    pd.DataFrame(precision_matrix).to_csv("training_csv/sensitivity_new/incolm_newparaeters_5.csv", index=False)
...
print("Test score:",accuracy_score(y_test, rfc_predict))
# print()
# print(oob_best_iter)
